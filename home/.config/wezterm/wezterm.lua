...
-- Hack only covers Latin glyphs. Pin PingFang SC as the CJK fallback;
-- otherwise macOS falls back to PingFang HK, which renders 、，。etc.
-- at the right-center of the cell (HK convention) instead of the
-- bottom-left (mainland convention).
