 ...
 *
 * Ported from aliou/pi-harness `tools/edit/kimi/edit.ts`; model-facing wording
 * generalized from Kimi K2.7 Code to the routed Kimi Code models.
 */
...
const KIMI_EDIT_GUIDELINES = [
  "edit: Use for every incremental file change when running a routed Kimi Code model. Do not use Write or Bash `sed` for small edits.",
