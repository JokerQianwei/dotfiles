 ...
 * in place with `pi.setActiveTools`.
 *
 * Ported from aliou/pi-harness `tools/edit` (nvim-undo integration removed).
 * File layout: all `pi.*` / `ctx.*` calls live here. Pure logic is in
 * `router.ts`, `default/edit.ts`, `anthropic/strict.ts`, `kimi/*`, and
 * `apply-patch/*`.
 */
